import HeathAsset from '../../assets/health.svg'
import ReportsAsset from '../../assets/report.svg'
import SyncAsset from '../../assets/sync.svg'
    ...
    return (
        <section className="container mx-auto px-6 p-10">
            ...
            <div className="flex items-center flex-wrap mb-20">
                ...
                <div className="w-full md:w-1/2">
                    <img src={HeathAsset} alt="Monitoring" />
                </div>
            </div>

            <div className="flex items-center flex-wrap mb-20">
                <div className="w-full md:w-1/2">
                    <img src={ReportsAsset} alt="Reporting" />
                </div>
